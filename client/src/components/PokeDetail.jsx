...
import { getDetailPokemon,clearDetail } from '../actions/index';
import styles from "./PokeDetail.module.css";
import gengar from "../images/tl.png"
                    ...
                    <div className={styles.picture}>
                        <div className={styles.pokemonCp}> 
                            {pokeDetail[0].db ? (
                                ...
                                <p className={styles.text1}>Pokemon ID-{pokeDetail[0]?.id}</p>
                            )}
                        </div>
                        {pokeDetail[0].image ? <img className={styles.image} src={pokeDetail[0].image} alt="Icon pokemon"/> : <img className={styles.rex} src={gengar} alt="Icon pokemon"/>}                        <div className={styles.circle}></div>
                    </div>
